...
public class TaskBReaderTest {
	...
	public void testReadTweets() throws Exception {
		...
		read = (TestingBTweet) allTweets.get(0);
		...
		read = (TestingBTweet) allTweets.get(1);
		...
		read = (TestingBTweet) allTweets.get(2);
		...
		read = (TestingBTweet) allTweets.get(3);
		...
		read = (TestingBTweet) allTweets.get(4);
